//MARGIN
var margin = {top: 10, right: 55, bottom: 40, left: 60},
...
var color = d3.scale.ordinal()
      .range(["#1f5188", "#b10318", "#FF0000", "#FF0099"]);
...
//DATA
d3.csv("/static/states/virginia/VASenate.csv", function (error, data) {
    ...
    //Initial Date
    var mindate = new Date("2017-02-15T00:00:00+00:00");
  ...
  legend.append("text")
    ...
    var seriesData = varVote.map(function (name) {
      ...
      var fltData = dataWithNaN.filter(function(d) { return !isNaN(d.value)});
          return {
                name: name,
                values: fltData
